...
Node.js WebSocket + HTTP (`/health`, **`/overview`** (сводка), **`/services`**, **`/list`**, **`/online`**, **`/kick`** — таблица путей в README), консольный клиент (`npm run cli`), Docker — см. [`presence_ws/README.md`](presence_ws/README.md).
